...
class LaravelHtmlMinifyServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app['router']->middleware('LaravelMinifyHtml', 'Thatobabusi\LaravelHtmlMinify\Middleware\LaravelMinifyHtml');

        $this->app['router']->aliasMiddleware('LaravelMinifyHtml', \Thatobabusi\LaravelHtmlMinify\Middleware\LaravelMinifyHtml::class);
        $this->app['router']->pushMiddlewareToGroup('web', \Thatobabusi\LaravelHtmlMinify\Middleware\LaravelMinifyHtml::class);
    }
}
